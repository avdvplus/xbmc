  ...
  if (strCharCode.size() == 3)
  {
    ...
    for (const auto& codes : LanguageCodes)
    {
      if (charCode == codes.iso639_2b ||
          (checkWin32Locales && codes.win_id != nullptr && charCode == codes.win_id))
      {
                                          ...
                                          bool checkWin32Locales /* = false */)
{
  ...
  for (const auto& codes : LanguageCodes)
  {
    if (strISO6392T == codes.iso639_2b ||
        (checkWin32Locales && codes.win_id != nullptr && strISO6392T == codes.win_id))
    {
...
const std::array<ISO639, 192> LanguageCodes = {{
    {"aa", "aar", nullptr, nullptr},
    {"ab", "abk", nullptr, nullptr},
    {"af", "afr", nullptr, nullptr},
    {"ak", "aka", nullptr, nullptr},
    {"am", "amh", nullptr, nullptr},
    {"ar", "ara", nullptr, nullptr},
    {"an", "arg", nullptr, nullptr},
    {"as", "asm", nullptr, nullptr},
    {"av", "ava", nullptr, nullptr},
    {"ae", "ave", nullptr, nullptr},
    {"ay", "aym", nullptr, nullptr},
    {"az", "aze", nullptr, nullptr},
    {"ba", "bak", nullptr, nullptr},
    {"bm", "bam", nullptr, nullptr},
    {"be", "bel", nullptr, nullptr},
    {"bn", "ben", nullptr, nullptr},
    {"bh", "bih", nullptr, nullptr},
    {"bi", "bis", nullptr, nullptr},
    {"bo", "tib", nullptr, "bod"},
    {"bs", "bos", nullptr, nullptr},
    {"br", "bre", nullptr, nullptr},
    {"bg", "bul", nullptr, nullptr},
    {"ca", "cat", nullptr, nullptr},
    {"cs", "cze", "ces", "ces"},
    {"ch", "cha", nullptr, nullptr},
    {"ce", "che", nullptr, nullptr},
    {"cu", "chu", nullptr, nullptr},
    {"cv", "chv", nullptr, nullptr},
    {"kw", "cor", nullptr, nullptr},
    {"co", "cos", nullptr, nullptr},
    {"cr", "cre", nullptr, nullptr},
    {"cy", "wel", nullptr, "cym"},
    {"da", "dan", nullptr, nullptr},
    {"de", "ger", "deu", "deu"},
    {"dv", "div", nullptr, nullptr},
    {"dz", "dzo", nullptr, nullptr},
    {"el", "gre", "ell", "ell"},
    {"en", "eng", nullptr, nullptr},
    {"eo", "epo", nullptr, nullptr},
    {"et", "est", nullptr, nullptr},
    {"eu", "baq", nullptr, "eus"},
    {"ee", "ewe", nullptr, nullptr},
    {"fo", "fao", nullptr, nullptr},
    {"fa", "per", nullptr, "fas"},
    {"fj", "fij", nullptr, nullptr},
    {"fi", "fin", nullptr, nullptr},
    {"fr", "fre", "fra", "fra"},
    {"fy", "fry", nullptr, nullptr},
    {"ff", "ful", nullptr, nullptr},
    {"gd", "gla", nullptr, nullptr},
    {"ga", "gle", nullptr, nullptr},
    {"gl", "glg", nullptr, nullptr},
    {"gv", "glv", nullptr, nullptr},
    {"gn", "grn", nullptr, nullptr},
    {"gu", "guj", nullptr, nullptr},
    {"ht", "hat", nullptr, nullptr},
    {"ha", "hau", nullptr, nullptr},
    {"he", "heb", nullptr, nullptr},
    {"hz", "her", nullptr, nullptr},
    {"hi", "hin", nullptr, nullptr},
    {"ho", "hmo", nullptr, nullptr},
    {"hr", "hrv", nullptr, nullptr},
    {"hu", "hun", nullptr, nullptr},
    {"hy", "arm", nullptr, "hye"},
    {"ig", "ibo", nullptr, nullptr},
    {"io", "ido", nullptr, nullptr},
    {"ii", "iii", nullptr, nullptr},
    {"iu", "iku", nullptr, nullptr},
    {"ie", "ile", nullptr, nullptr},
    {"ia", "ina", nullptr, nullptr},
    {"id", "ind", nullptr, nullptr},
    // in deprecated https://www.loc.gov/standards/iso639-2/php/code_changes_bycode.php?code_ID=207
    {"in", "ind", nullptr, nullptr},
    {"ik", "ipk", nullptr, nullptr},
    {"is", "ice", "isl", "isl"},
    {"it", "ita", nullptr, nullptr},
    // iw deprecated https://www.loc.gov/standards/iso639-2/php/code_changes_bycode.php?code_ID=184
    {"iw", "heb", nullptr, nullptr},
    {"jv", "jav", nullptr, nullptr},
    {"ja", "jpn", nullptr, nullptr},
    {"kl", "kal", nullptr, nullptr},
    {"kn", "kan", nullptr, nullptr},
    {"ks", "kas", nullptr, nullptr},
    {"ka", "geo", nullptr, "kat"},
    {"kr", "kau", nullptr, nullptr},
    {"kk", "kaz", nullptr, nullptr},
    {"km", "khm", nullptr, nullptr},
    {"ki", "kik", nullptr, nullptr},
    {"rw", "kin", nullptr, nullptr},
    {"ky", "kir", nullptr, nullptr},
    {"kv", "kom", nullptr, nullptr},
    {"kg", "kon", nullptr, nullptr},
    {"ko", "kor", nullptr, nullptr},
    {"kj", "kua", nullptr, nullptr},
    {"ku", "kur", nullptr, nullptr},
    {"lo", "lao", nullptr, nullptr},
    {"la", "lat", nullptr, nullptr},
    {"lv", "lav", nullptr, nullptr},
    {"li", "lim", nullptr, nullptr},
    {"ln", "lin", nullptr, nullptr},
    {"lt", "lit", nullptr, nullptr},
    {"lb", "ltz", nullptr, nullptr},
    {"lu", "lub", nullptr, nullptr},
    {"lg", "lug", nullptr, nullptr},
    {"mk", "mac", nullptr, "mdk"},
    {"mh", "mah", nullptr, nullptr},
    {"ml", "mal", nullptr, nullptr},
    {"mi", "mao", nullptr, "mri"},
    {"mr", "mar", nullptr, nullptr},
    {"ms", "may", nullptr, "msa"},
    {"mg", "mlg", nullptr, nullptr},
    {"mt", "mlt", nullptr, nullptr},
    {"mn", "mon", nullptr, nullptr},
    {"my", "bur", nullptr, "mya"},
    {"na", "nau", nullptr, nullptr},
    {"nv", "nav", nullptr, nullptr},
    {"nr", "nbl", nullptr, nullptr},
    {"nd", "nde", nullptr, nullptr},
    {"ng", "ndo", nullptr, nullptr},
    {"ne", "nep", nullptr, nullptr},
    {"nl", "dut", "nld", "nld"},
    {"nn", "nno", nullptr, nullptr},
    {"nb", "nob", nullptr, nullptr},
    {"no", "nor", nullptr, nullptr},
    {"ny", "nya", nullptr, nullptr},
    {"oc", "oci", nullptr, nullptr},
    {"oj", "oji", nullptr, nullptr},
    {"or", "ori", nullptr, nullptr},
    {"om", "orm", nullptr, nullptr},
    {"os", "oss", nullptr, nullptr},
    {"pa", "pan", nullptr, nullptr},
    // pb / pob = unofficial language code for Brazilian Portuguese
    {"pb", "pob", nullptr, nullptr},
    {"pi", "pli", nullptr, nullptr},
    {"pl", "pol", "plk", nullptr},
    {"pt", "por", "ptg", nullptr},
    {"ps", "pus", nullptr, nullptr},
    {"qu", "que", nullptr, nullptr},
    {"rm", "roh", nullptr, nullptr},
    {"ro", "rum", "ron", "ron"},
    {"rn", "run", nullptr, nullptr},
    {"ru", "rus", nullptr, nullptr},
    {"sh", "scr", nullptr, nullptr},
    {"sg", "sag", nullptr, nullptr},
    {"sa", "san", nullptr, nullptr},
    {"si", "sin", nullptr, nullptr},
    {"sk", "slo", "sky", "slk"},
    {"sl", "slv", nullptr, nullptr},
    {"se", "sme", nullptr, nullptr},
    {"sm", "smo", nullptr, nullptr},
    {"sn", "sna", nullptr, nullptr},
    {"sd", "snd", nullptr, nullptr},
    {"so", "som", nullptr, nullptr},
    {"st", "sot", nullptr, nullptr},
    {"es", "spa", "esp", nullptr},
    {"sq", "alb", nullptr, "sqi"},
    {"sc", "srd", nullptr, nullptr},
    {"sr", "srp", nullptr, nullptr},
    {"ss", "ssw", nullptr, nullptr},
    {"su", "sun", nullptr, nullptr},
    {"sw", "swa", nullptr, nullptr},
    {"sv", "swe", "sve", nullptr},
    {"ty", "tah", nullptr, nullptr},
    {"ta", "tam", nullptr, nullptr},
    {"tt", "tat", nullptr, nullptr},
    {"te", "tel", nullptr, nullptr},
    {"tg", "tgk", nullptr, nullptr},
    {"tl", "tgl", nullptr, nullptr},
    {"th", "tha", nullptr, nullptr},
    {"ti", "tir", nullptr, nullptr},
    {"to", "ton", nullptr, nullptr},
    {"tn", "tsn", nullptr, nullptr},
    {"ts", "tso", nullptr, nullptr},
    {"tk", "tuk", nullptr, nullptr},
    {"tr", "tur", "trk", nullptr},
    {"tw", "twi", nullptr, nullptr},
    {"ug", "uig", nullptr, nullptr},
    {"uk", "ukr", nullptr, nullptr},
    {"ur", "urd", nullptr, nullptr},
    {"uz", "uzb", nullptr, nullptr},
    {"ve", "ven", nullptr, nullptr},
    {"vi", "vie", nullptr, nullptr},
    {"vo", "vol", nullptr, nullptr},
    {"wa", "wln", nullptr, nullptr},
    {"wo", "wol", nullptr, nullptr},
    {"xh", "xho", nullptr, nullptr},
    {"yi", "yid", nullptr, nullptr},
    {"yo", "yor", nullptr, nullptr},
    {"za", "zha", nullptr, nullptr},
    {"zh", "chi", "zho", "zho"},
    {"zu", "zul", nullptr, nullptr},
    {"zv", "und", nullptr, nullptr}, // Kodi intern mapping for missing "Undetermined" iso639-1 code
    {"zx", "zxx", nullptr,
     nullptr
    ...
    {"zz", "mul", nullptr, nullptr} // Kodi intern mapping for missing "Multiple languages" iso639-1 code
}};
// clang-format on
